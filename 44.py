...
if test == 1:
    ...
    log_dir = './compare32/'+str(num)+'volemptyconcat2'


load_dir = './compare32/'+str(num)+'volemptyconcat2'
#load_dir =0
if(load_dir != 0):
    test = 1
...
class Generator(nn.Module):
    ...
    def __init__(self, seg_label):
        ...
        self.sp1 = SPADEResnetBlock(512, 256, seg_label)
        # 8*8
        self.sp2 = SPADEResnetBlock(256, 128, seg_label)
        # 16*16
        self.sp3 = SPADEResnetBlock(128, 2, seg_label)
        # 32*32
